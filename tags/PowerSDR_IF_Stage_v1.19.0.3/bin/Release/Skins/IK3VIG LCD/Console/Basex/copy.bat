...
copy %display% %skinpath%panDisplayBack.png
...
copy %rx2up% %skinpath%ckRX2-0.png
copy %rx2dn% %skinpath%ckRX2-1.png
...
copy %up2% %skinpath%f-0.png
copy %dn2% %skinpath%chkBCI-1.png


copy %up3% %skinpath%btnDisplayZoom05-0.png
copy %dn3% %skinpath%btnDisplayZoom05-1.png
copy %up3% %skinpath%btnDisplayZoom1x-0.png
copy %dn3% %skinpath%btnDisplayZoom1x-1.png
copy %up3% %skinpath%btnDisplayZoom2x-0.png
copy %dn3% %skinpath%btnDisplayZoom2x-1.png
copy %up3% %skinpath%btnDisplayZoom4x-0.png
copy %dn3% %skinpath%btnDisplayZoom4x-1.png
...
copy %up1% %skinpath%btnFWCATU-0.png
copy %up1% %skinpath%chkX2TR-0.png
copy %up1% %skinpath%btnFWCATUBypass-0.png
...
copy %dn1% %skinpath%btnFWCATU-1.png
copy %dn1% %skinpath%chkX2TR-1.png
copy %dn1% %skinpath%btnFWCATUBypass-1.png
