...
namespace PowerSDR
{
	public class Setup : System.Windows.Forms.Form
	{
		...
		public Setup(Console c)
		{
			...
			comboDSPWindow.SelectedIndex = (int)DttSP.Window.BLKHARRIS;
		...
		private void InitializeComponent()
		{
			...
			this.grpOptMisc.Size = new System.Drawing.Size(144, 120);
			...
			this.grpAudioVolts1.Visible = false;
			// 
			// btnAudioVoltTest1
			// 
			...
			this.toolTip1.SetToolTip(this.udDisplayWaterfallUpdatePeriod, "When averaging, use this number of buffers to calculate the average.");
			...
			this.lblDisplayWaterfallAverageTime.Text = "Averging Time (ms):";
			// 
			// clrbtnWaterfallLow
			// 
			...
			// chkBlkLMSNR
			// 
			this.chkBlkLMSNR.Checked = true;
			this.chkBlkLMSNR.CheckState = System.Windows.Forms.CheckState.Checked;
			...
			// chkBlkLMSANF
			// 
			this.chkBlkLMSANF.Checked = true;
			this.chkBlkLMSANF.CheckState = System.Windows.Forms.CheckState.Checked;
			...
			this.rtxtPACalReq.Location = new System.Drawing.Point(232, 16);
			...
			this.grpPAGainByBand.Controls.Add(this.label1);
			...
			this.grpPAGainByBand.Size = new System.Drawing.Size(216, 272);
		...
		private void comboDSPBufSize_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			...
			console.FilterSizeCalOffset = (float)offset;
